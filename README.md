...
[![Build Status](https://travis-ci.org/diSimplex/golua.svg?branch=master)](https://travis-ci.org/diSimplex/golua)

Simplest way to install:

	# go get github.com/diSimplex/golua/lua
...
$ go get -f -u -tags luajit github.com/diSimplex/golua/lua
```
